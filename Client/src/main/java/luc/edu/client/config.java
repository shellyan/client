...
public class config extends Application{
    public static final String base_URL = "http://pervasive-dev.cs.luc.edu:8080/sensor-proxy-restful/";
    ...
    public static class TabsAdapter extends FragmentPagerAdapter
        ...
        static final class TabInfo {
            ...
            TabInfo(TabHost.TabSpec _tabSpec, Class<?> _class, Bundle _args) {
                tabSpec = _tabSpec;
                clss = _class;
                args = _args;
            }
...
//            String tag = tabSpec.getTag();
            TabInfo info = new TabInfo(tabSpec, clss, args);
        ...
        public void removeTab( String _tag){
